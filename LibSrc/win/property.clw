...
PROP:TouchInterface   EQUATE(7A79H)  ! integer (read-only): get the interface to touch input
...
PROP:NoKeyProject       EQUATE (725DH)
PROP:SQLRowSet          EQUATE (725FH)
