...
TextReportGenerator.IReportGenerator.SupportPageProcessing PROCEDURE()
 CODE
    RETURN TRUE

TextReportGenerator.IReportGenerator.OpenPage PROCEDURE(STRING PageName)
 CODE
    RETURN Level:Benign

TextReportGenerator.IReportGenerator.StartPageProcess            PROCEDURE(SHORT pBoxLeft,SHORT pBoxTop,SHORT pBoxRight,SHORT pBoxBottom,STRING pPageName)
 CODE
...
TextReportGenerator.IReportGenerator.GetFileName              PROCEDURE()
 CODE
...
TextReportGenerator.IReportGenerator.SupportPageParsing  PROCEDURE()
 CODE
 RETURN True
